var productAdmin = function(){
    ...
    for (var i in product)
    {
     ...
     var listproduct1 = '<tr>';
      ...
      listproduct1+='<td><img src="../assets/img/'+data.img+'" alt="" style="width: 50px;"></td>';
...
var addProduct = function(){
    ...
    var updateProduct = function(i){
        ...
        document.getElementById("imaged").value = k.img;
    ...
    var submitUpdate = function(i){
        ...
        k.img= document.getElementById("imaged").value;
